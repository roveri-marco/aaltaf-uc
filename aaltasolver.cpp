...
void AaltaSolver::exploreLiteralCombinations(Minisat::vec<Minisat::Lit>&    lits,
                                             int                            index,
...
void AaltaSolver::processPermutations(Minisat::vec<Minisat::Lit>&    combination,
                                      int                            start,
                                      int                            end,
                                      std::vector<std::vector<int>>& all_mus) {
  if (true) {
...
bool AaltaSolver::contains(const std::vector<std::vector<int>>& all_mus,
